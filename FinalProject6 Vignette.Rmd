...
We may also want to run a bootstrap procedure to obtain confidence intervals for each $\beta$ estimate. To run a bootstrap procedure at significance level $0.01$ (to obtain $99\%$ confidence intverals) for $10$ bootstraps, we can call
